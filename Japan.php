...
<body>
    ...
    <div class="content">
        <h4><a href="index.php" style="color: black;">Kategori</a> > Japan</h4>
    ...
    <script>
        ...
        document.getElementById("hasil").innerText = "Ada " + jumlahSel + " Artikel tentang Japan ";
    </script>
    <script>
