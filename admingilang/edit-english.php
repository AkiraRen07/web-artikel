...
<body>
    ...
    <div class="content">
        ...
        <?php
        $id = $_GET['id'];
        $sql = mysqli_query($db_link, "SELECT * FROM english WHERE id='$id'");
    ...
    if (isset($_POST['proses'])) {
        ...
        if ($image != "") {
            ...
            if (in_array($ekstensi, $ekstensi_berhasil) === true) {
                ...
                $query = mysqli_query($db_link, "UPDATE english SET judul='$judul', tanggal='$tanggal', link='$link', image='$new_name' WHERE id='$id'");
            ...
            $query = mysqli_query($db_link, "UPDATE english SET judul='$judul', tanggal='$tanggal', link='$link' WHERE id='$id'");
