...
<body>
    ...
    <nav class="navbar">
        <ul>
            ...
            <li><a class="active" href="./english.php"><i class="fa-solid fa-book"></i>English</a></li>
    ...
    <div class="content">
        ...
        <hr>
        <br>
        <form action="tambah-english.php" method="post" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>Id</td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button id="kembali"><a href="english.php">Kembali</a></button>
                    </td>
    ...
    if (isset($_POST['proses'])) {
        ...
        if ($image != "") {
            ...
            if (in_array($ekstensi, $ekstensi_berhasil) === true) {
                ...
                $query = mysqli_query($db_link, "INSERT INTO english (judul, tanggal, link, image) VALUES ('$judul','$tanggal','$link','$new_name')");
                ...
                if (!$query) {
                    ...
                    echo "<meta http-equiv='refresh' content='1;url=http://localhost/Website_statis/admingilang/english.php'>";
                }
            } else {
                echo "<script>alert('Ekstensi gambar hanya bisa png, jpg, dan jpeg!');</script>";
            }
        } else {
            $query = mysqli_query($db_link, "INSERT INTO english (judul, tanggal, link) VALUES ('$judul','$tanggal','$link')");
