...
<body>
    ...
    <div class="content">
        ...
        <hr>
        <br>
        <form action="tambah-japan.php" method="post" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>Id</td>
    ...
    if (isset($_POST['proses'])) {
        ...
        if ($image != "") {
            ...
            if (in_array($ekstensi, $ekstensi_berhasil) === true) {
                ...
                $query = mysqli_query($db_link, "INSERT INTO japan (judul, tanggal, link, image) VALUES ('$judul','$tanggal','$link','$new_name')");
            ...
            $query = mysqli_query($db_link, "INSERT INTO japan (judul, tanggal, link) VALUES ('$judul','$tanggal','$link')");
