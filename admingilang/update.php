        ...
        <table id="table">
            ...
            while ($data = mysqli_fetch_array($query)) { ?>
                <tbody>
                    ...
                    <td><?= $data['link'] ?></td>
                    <td>
                        <button id='edit'><a href='edit-data.php?id=<?= $data["id"] ?>'><i class='fa-solid fa-pen-to-square'></i></a></button>
                        <button id='hapus'><a href='hapus-data.php?id=<?= $data["id"] ?>'><i class='fa-solid fa-trash'></i></a></button>
            ...
            ?>
            <tr>
                <td colspan="5"><input type="button" value="TAMBAH DATA" onclick="location.href='tambah-data.php'" id="tambah"></td>
            </tr>
        </table>
